...
//		if((temp==0)&&(rx_echo_buff[0]==0xFF))
//		{
//			if((((0xFF+rx_echo_buff[1]+rx_echo_buff[2])&0xFF)==rx_echo_buff[3]))
//				rx_echo=rx_echo_buff[1]*256+rx_echo_buff[2];
//			else rx_echo=-3.1415926;
