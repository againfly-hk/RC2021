...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN PTD */
//#define	UART_BUFFSIZE	50
//typedef struct{
//	uint8_t sendlen;
//	uint8_t recvlen;
//	uint8_t sendbuff[UART_BUFFSIZE];
//	uint8_t recv1buff[UART_BUFFSIZE];
//	uint8_t recv2buff[UART_BUFFSIZE];
//}uart1_buff,uart6_buff;
...
uint8_t spi_tx_buff[8]={0xFF,0x11,0xAA};
uint8_t spi_rx_buff[8];
/* USER CODE END PV */
